    ...
    public partial class FormCommand : Form {
        ...
        private void button1_Click(object sender, EventArgs e) {
            ...
            if (newActionForm.selectedType != "") {
                if (newActionForm.selectedType == "Key press" && newActionForm.selectedKey != Keys.None
                    ...
                    Actions myNewAction = new Actions(newActionForm.selectedType, newActionForm.selectedKey, newActionForm.newList, newActionForm.selectedTimer);
        ...
        private void button2_Click(object sender, EventArgs e) {
            ...
            if (a != null) {
                ...
                a.modifiers = formEditAction.newList;
